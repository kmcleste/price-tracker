...
class Scraper():
    ...
    def get_price(self):
        return self.soup.find("span", attrs={"class":"a-offscreen"}).text.strip()
    def get_stock_status(self):
        return self.soup.find("div", attrs={"id":"availability"}).text.strip()
    def get_ratings(self):
        return self.soup.find("span", attrs={"class":"a-icon-alt"}).text.strip()
    def get_ratings_count(self):
        return self.soup.find("span", attrs={"id":"acrCustomerReviewText"}).text.strip()
